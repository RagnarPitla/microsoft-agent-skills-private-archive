...
provenance: "Power Platform and Copilot Studio changes that passed review and broke something in a different solution, environment or channel, and the platform dependency views that would have caught them first."
---
...
Companion to [review-copilot-studio-agent](../review-copilot-studio-agent/SKILL.md),
which reads one agent's configuration for defects, and to
[power-platform-alm-connection-refs](../../operate/power-platform-alm-connection-refs/SKILL.md),
